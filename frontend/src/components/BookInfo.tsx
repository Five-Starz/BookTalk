  ...
  return (
    <div className="m-auto flex flex-col gap-12 md:gap-24">
      ...
      <div>
        ...
        <div className='flex justify-between flex-wrap gap-2 hidden md:flex'>
        ...
        <div className='flex justify-between flex-wrap gap-2 md:hidden'>
          <ReviewCard width='[calc(50%-6px)]' />
          <ReviewCard width='[calc(50%-6px)]' />
        </div>
      </div>
      <div>
