import React from 'react'; // useState, useEffect, FormEvent 등은 훅 안으로 이동
import { useParams } from 'react-router-dom'; // useNavigate도 훅 안으로 이동
// axios도 훅 안으로 이동

// ReviewDetail 타입은 더 이상 여기서 직접 사용하지 않으므로 제거 (formData는 훅에서 관리)
